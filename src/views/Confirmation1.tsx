...
const Confirmation1 = () => {
    ...
    return (
        <div>
            <h1 style={h1Style}>
                Thanks for signing up! We'll be reviewing your organization
                application soon
            </h1>

            <h2 style={h2Style}>
                Please wait for our team to personally verify your account
                before you're are able to post any volunteer opportunities.{" "}
            </h2>
            <h2 style={h2Style}>
                For now, please check your inbox to verify your email.
            </h2>
            <h2 style={h2Style}>
                If you don't see this email within <strong>72</strong> hours,
                please contact support team for assistance.
            </h2>
            <h2></h2>
