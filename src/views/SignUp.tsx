...
const SignUp = () => {
    ...
    useEffect(() => {
        if (signupDetails.description === "" || signupDetails.password === "" || signupDetails.email === "" || signupDetails.postalCode === "" || errorVisible === "block"
    ...
    const submitSignupDetails = async (e: any) => {
        ...
        const uploadImageRequest = await axios.post(url, formData, {
            headers: {
                'Content-Type': 'multipart/form-data',
