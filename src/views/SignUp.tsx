    ...
    <div>
        ...
        <Grid container style = {indent}>
            ...
            <Grid style = {indent} item xs={5}>
                ...
                <StyledButton onClick = {handleLoginClick} style = {buttonStyle}>Sign up</StyledButton>

                <br></br>
                <h4 style = {h4Style}>Have an account? <a style = {blue} onClick={handleLoginClick}>Login</a></h4>
